...
Alas, it didn't work. If you haven't spotted the bug, you might want to try the following simplified version in Firebug or Safari's error console:
...
Unfortunately, the simple example doesn't work either:
...
It's so well known that you shouldn't need any additional syntactic sugar. But since you're sticking around, you may prefer this variation:
...
What we've done is extracted the variable declaration and turned it into a parameter of our anonymous function. This is the basis of the common abbreviation pattern you see in code like this:
