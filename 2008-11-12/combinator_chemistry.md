...
*This is a bit of a linkjack, however the original posts have some broken links, a post that was revised and reposted, and some pages do not link to the other posts. This post is simply a list of links to the final set of posts. If you enjoyed Bruno's posts, may I suggest a few of my own explaining some Ruby programming ideas in terms of combinators?*
