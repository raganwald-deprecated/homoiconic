...
(The ode examples are in JavaScript. [Click Here](./turtles-and-iterators.md#tortoises-teleporting-turtles-and-iterators) to see the code examples in CoffeeScript)
